...
- «Загрузка файла»
    ...
    2. Заполните информацию, следуя подсказкам из шаблона. Обязательные поля помечены желтым цветом. 
        ...
        Если требуются дополнительные поля, то в шаблоне можно добавить столбцы и заполнять информацию, которая необходима конкретному клиенту. 
    ...
    **Шаг 3. Проверка загруженной информации и конкретизация**
...
**3.2. Сопоставление номенклатуры**
